...
const fridgeAudio = new RefrigeratorAudio();
        ...
        <div className="fridge-container">
          ...
          <div className="fridge-cabinet">
            <div className={`fridge-interior ${doorOpen ? "light-on" : ""}`}>
              ...
              {/* Interior is now shown in fullscreen overlay, not here */}
            </div>
          </div>
          ...
          <div className={`fridge-door-wrapper ${doorOpen ? "open" : ""}`}>
            <div className="fridge-door">
              ...
              <div className="door-front brushed-metal">
                <div className="door-front-header">
                  {/* <div className="fridge-logo">Softspire</div>
                  <div className={`fridge-status-dot ${loggedIn ? "unlocked" : ""}`}></div> */}
                </div>
